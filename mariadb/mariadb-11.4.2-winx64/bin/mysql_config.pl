...
my $pkglibdir = fix_path('C:/Program Files/MariaDB/lib',"libmysql/relwithdebinfo",
                         "libmysql/release","libmysql/debug","lib/mysql","lib");

my $pkgincludedir = fix_path('C:/Program Files/MariaDB/include/mysql', "include/mysql", "include");
