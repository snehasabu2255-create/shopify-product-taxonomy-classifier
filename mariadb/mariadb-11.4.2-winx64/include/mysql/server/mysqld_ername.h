...
{ "ER_SET_PASSWORD_AUTH_PLUGIN", 1699, "SET PASSWORD is ignored for users authenticating via %s plugin" },
...
{ "ER_USER_IS_BLOCKED", 4150, "User is blocked because of too many credential errors; unblock with \'FLUSH PRIVILEGES\'" },
